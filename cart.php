        ...
        <div class="shopping-cart">
            ...
            <?php if ($shoppingCart->hasProducts()): ?>
                ...
                <?php foreach ($shoppingCart->getProducts() as $index => $product): ?>
                    ...
                    <img class="img" src="<?php echo $product->getImage() ?>">
                ...
                <?php endforeach; ?>
                <strong>Totaalbedrag: €<?php echo $shoppingCart->TotalPrice() ?></strong>
                <a href="cart.php?action=clear_all">Verwijder alles</a>
            <?php else: ?>
